...
const shifts = [
  ...
  { guard: 'Marcus Thompson', location: 'Westgate Mall',        time: '10:00 – 18:00', status: 'scheduled' },
  { guard: 'Sarah Chen',      location: 'Riverside Tower',      time: '16:00 – 00:00', status: 'scheduled' },
]
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="ml-3 flex-1 rounded px-3 py-1 text-xs text-slate-500"
          style={{ background: 'rgba(30,58,95,0.2)' }}
        >
          app.vantagefield.app / shifts
        </div>
      </div>
      ...
      <div className="flex" style={{ background: 'rgba(6,11,20,0.9)', minHeight: 320 }}>
        {/* Sidebar */}
        <div
          className="w-48 flex-shrink-0 p-4 space-y-1"
          ...
          {NAV_ITEMS.map((item) => (
            <div
              ...
              className={`text-xs rounded-lg px-3 py-2 transition-colors ${
                item === ACTIVE_NAV ? 'text-gold font-semibold' : 'text-slate-500'
              }`}
              style={{
                background: item === ACTIVE_NAV ? 'rgba(201,168,76,0.12)' : 'transparent',
              }}
            >
              {item}
            </div>
        ...
        <div className="flex-1 p-5">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <div className="text-xs text-slate-500 mt-0.5">3 shifts today</div>
            </div>
            <div
              ...
              <motion.div
                ...
                style={{
                  background: s.status === 'active'
                    ...
                    : 'rgba(30,58,95,0.18)',
                  border: `1px solid ${
                    s.status === 'active' ? 'rgba(34,197,94,0.2)' : 'rgba(30,58,95,0.3)'
                  }`,
                }}
              ...
              >
                ...
                <div className="flex items-center gap-1.5">
                  <div
                    ...
                    style={{ background: STATUS[s.status].dot }}
                  />
                  <span className="text-xs" style={{ color: STATUS[s.status].dot }}>
